...
namespace AIAssistantService.Plugins
{
    public class EMarketApiPlugin
    {
        ...
        public EMarketApiPlugin(IHttpClientFactory factory)
        {
        ...
        // 2. Customer
        [KernelFunction]
        [Description("Retrieves information about customers, including their profiles, statistics, addresses, segments, and top rankings. Use this tool for ANY customer-related queries.")]
        ...
        // 3. Dashboard
        [KernelFunction]
        [Description("Retrieves generic dashboard metrics, charts, performance overviews, people stats, warehouse operations, finance summaries, and debt hubs. Use this tool when the user asks for high-level summaries, aggregate data, or system-wide metrics.")]
        public Task<string> GetDashboardData(
            [Description("The specific dashboard report. VALID VALUES: 'summary', 'branch-performance', 'stock-chart', 'overview', 'people', 'warehouse', 'finance', 'debt', 'super-admin'")] string action,
            ...
            [Description("Filter by a specific Supplier ID.")] int supplierId = 0)
        {
            return action switch
            {
                "summary" => SafeGetAsync($"api/admin/dashboard/summary{BuildQs(("branchId", branchId))}"),
        ...
        // 4. Expense
        [KernelFunction]
        [Description("Retrieves financial expenses and expense categories within the system. Use this tool whenever a user asks about expenses, operational costs, or spending records.")]
        ...
        // 5. Inventory
        [KernelFunction]
        [Description("Retrieves inventory stock items, current stock quantities, and stock movement histories (import/export). Use this tool whenever the user asks about available stock in warehouses or inventory tracking.")]
        ...
        [KernelFunction]
        [Description("Retrieves Purchase Orders made to suppliers for importing products into the warehouse. Use this tool for queries about inventory imports, purchase history, and supplier orders.")]
        ...
        [KernelFunction]
        [Description("Retrieves Debt records owed to suppliers, including overdue checks and payments made to clear debts. Use this tool for queries about liabilities, debts to suppliers, and supplier payments.")]
        ...
        // 6. Log
        [KernelFunction]
        [Description("Retrieves system logs, audit logs, error logs, and activity events. Use this tool when users investigate errors, user actions, or tracking system performance.")]
        ...
        // 7. Product
        [KernelFunction]
        [Description("Retrieves information about standard products, catalogues, stock alerts, and product images. Use this tool to answer ANY queries regarding general items/products in the EMarket catalog.")]
        ...
        [KernelFunction]
        [Description("Retrieves product Lots/Batches. Use this tool when users ask about expiration dates (HSD/NSX), product batches, or specific lot instances stored in the warehouse.")]
        ...
        [KernelFunction]
        [Description("Retrieves Product Categories and external Suppliers. Use this tool for navigating taxonomies or looking up external vendors/suppliers.")]
        ...
        // 9. Sales
        [KernelFunction]
        [Description("Retrieves retail and wholesale sales orders, including transaction states, order line details, and associated payments. Use this tool for queries about customer orders, purchasing history, and branch revenue.")]
        ...
        // 10. User Management
        [KernelFunction]
        [Description("Retrieves administrative system users, staff, personnel, and managers. Use this tool when querying employee accounts, active users, and system administrators.")]
